...
namespace Ejercicio_4_DocenteAlumnos
{
    public partial class fmrAlumno : Form
    {
        ...
        { 
            ...
            Ejercicio4.WriteLine(Alumno.Nombre[0]);
            Ejercicio4.WriteLine(Alumno.Fecha[0]);
            Ejercicio4.WriteLine(Alumno.Curp[0]);
            Ejercicio4.WriteLine(Alumno.Telefono[0]);
            Ejercicio4.WriteLine(Alumno.Email[0]);
            Ejercicio4.WriteLine(Alumno.Control[0]);
            Ejercicio4.WriteLine(Alumno.Carrera[0]);
            Ejercicio4.WriteLine(Alumno.Calificacion[0]);
            Ejercicio4.Close();
        }

        private void fmrAlumno_Load(object sender, EventArgs e)
        {
            Ejercicio4 = new StreamWriter("Alumno2.txt");
        }
    }
}
