...
namespace Ejercicio_4_DocenteAlumnos
{
    public partial class fmrDocente : Form
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            Ejercicio4.WriteLine(Docente.Nombre[0]);
            Ejercicio4.WriteLine(Docente.Fecha[0]);
            Ejercicio4.WriteLine(Docente.Curp[0]);
            Ejercicio4.WriteLine(Docente.Telefono[0]);
            Ejercicio4.WriteLine(Docente.Email[0]);
            Ejercicio4.WriteLine(Docente.Numero[0]);
            Ejercicio4.WriteLine(Docente.Sueldo[0]);
            Ejercicio4.WriteLine(Docente.MateriasImparte[0]);
            Ejercicio4.Close();
        }

        private void fmrDocente_Load(object sender, EventArgs e)
        {
            Ejercicio4 = new StreamWriter("Docente2.txt");
        }
    }
}
