...
namespace Array_List
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Miprimeraclase = new StreamWriter("MiPrimeraClase.txt");
...

        {
            ...
            Miprimeraclase.WriteLine(miPersona.ID);

            Miprimeraclase.WriteLine(miPersona.Nombres);

            Miprimeraclase.WriteLine(miPersona.Apellidos);

            Miprimeraclase.WriteLine(miPersona.Correo);

            Miprimeraclase.WriteLine(miPersona.Salario);

            Miprimeraclase.Close();
